...
type ARPStats struct {
	...
	// dropped due to the ARP packet header failing validation checks (bad size,
	// incorrect fields).
	MalformedPacketsReceived *StatCounter
	...
	// RequestsReceivedUnknownTargetAddress is the total number of ARP requests
	// received by a NIC that is not assigned to the target address.
	...
	// OutgoingRequestsDropped is the total number of ARP requests which failed
	// to write to a link-layer endpoint.
	...
	// OutgoingRepliesDropped is the total number of ARP replies which failed to
